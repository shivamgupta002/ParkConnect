...
async def generate_vehicle_qr(
    ...
    """Generates (or regenerates) the QR code for a vehicle the current user
    owns. Regenerating deactivates the vehicle's previous QR rather than
    deleting it — see qr_service.issue_qr_for_vehicle."""
    try:
